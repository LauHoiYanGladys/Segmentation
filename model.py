...
class UNet_3Plus_DeepSup(nn.Module):
    ...
    def forward(self, inputs):
        ...
        out_d2 = torch.sigmoid(d2)
        out_d3 = torch.sigmoid(d3)
        out_d4 = torch.sigmoid(d4)
        out_d5 = torch.sigmoid(d5)
...
# code taken from https://github.com/anudeepsekhar/deep_learning_for_demosaicing/blob/main/model.py
...
# code taken from https://github.com/4uiiurz1/pytorch-nested-unet/blob/master/archs.py
